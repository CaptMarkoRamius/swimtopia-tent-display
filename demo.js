...
export function loadDemoData() {
  ...
  // Heat 2 of Event 28 (50 Fly Boys 9-10) is currently in the water
  S.tracker = {
    isLive: true, isComplete: false,
    currentEventNumberDigit: '28', currentHeatNumber: 2,
    currentEventDistance: 50, currentEventStrokeCode: 4,
    currentEventGender: 'M', currentEventMinAge: 9, currentEventMaxAge: 10,
  };

  // Done relays: e73=200 Medley (1st, 1:59.03), e74=200 Free (2nd, 1:52.45)
  // e28 50 Fly: heat 1 (Jackson, Lucas) DONE; heat 2 (Ethan, Noah) INPROGRESS
  ...
  S.swimmers = [
    {
      ...
      events: [
        { eventId: 'e14', name: '50 Free',  number: '14', schedIdx: 14001, status: 'done',
          heatNum: 2, laneNum: 5, offTime: 3287, seedTime: 3350, place: 1, heatPlace: 1, qualifying: ['INV'], isDq: false },
        { eventId: 'e21', name: '100 Back', number: '21', schedIdx: 21001, status: 'done',
          heatNum: 1, laneNum: 4, offTime: 7954, seedTime: 8100, place: 3, heatPlace: 2, qualifying: [], isDq: false },
        { eventId: 'e73', name: '200 Medley Relay', number: '73', schedIdx: 73001, status: 'done',
          heatNum: 2, laneNum: 3, offTime: 11903, place: 1, isDq: false, isRelay: true,
          relayTeam: 'A', legPosition: 4, legStroke: 1, qualifying: [] },
        { eventId: 'e74', name: '200 Free Relay', number: '74', schedIdx: 74001, status: 'done',
          heatNum: 2, laneNum: 5, offTime: 11245, place: 2, isDq: false, isRelay: true,
          relayTeam: 'A', legPosition: 4, legStroke: 1, qualifying: [] },
        { eventId: 'e28', name: '50 Fly', number: '28', schedIdx: 28001, status: 'inProgress',
    ...
    },
    {
      ...
      events: [
        { eventId: 'e14', name: '50 Free',  number: '14', schedIdx: 14001, status: 'done',
          heatNum: 2, laneNum: 3, offTime: 3412, seedTime: 3380, place: 4, heatPlace: 3, qualifying: [], isDq: false },
        { eventId: 'e21', name: '100 Back', number: '21', schedIdx: 21001, status: 'done',
          heatNum: 1, laneNum: 6, offTime: 8560, seedTime: 8400, place: 6, heatPlace: 4, qualifying: [], isDq: false },
        { eventId: 'e73', name: '200 Medley Relay', number: '73', schedIdx: 73001, status: 'done',
          heatNum: 2, laneNum: 3, offTime: 11903, place: 1, isDq: false, isRelay: true,
    ...
    },
    {
      ...
      events: [
        { eventId: 'e14', name: '50 Free',  number: '14', schedIdx: 14001, status: 'done',
          heatNum: 2, laneNum: 7, offTime: 3501, seedTime: 3490, place: 5, heatPlace: 5, qualifying: [], isDq: false },
        { eventId: 'e73', name: '200 Medley Relay', number: '73', schedIdx: 73001, status: 'done',
          heatNum: 2, laneNum: 3, offTime: 11903, place: 1, isDq: false, isRelay: true,
        ...
        { eventId: 'e28', name: '50 Fly', number: '28', schedIdx: 28001, status: 'done',
          heatNum: 1, laneNum: 2, offTime: 4312, seedTime: 4250, place: 6, heatPlace: 3, qualifying: [], isDq: false },
        { eventId: 'e80', name: '200 Medley Relay', number: '80', schedIdx: 80001, status: 'upcoming',
          heatNum: 2, laneNum: 3, etaEpoch: eta(25 * 60), etaDisplay: etaFmt(25 * 60),
    ...
    },
    {
      ...
      events: [
        { eventId: 'e21', name: '100 Back', number: '21', schedIdx: 21001, status: 'done',
          heatNum: 2, laneNum: 3, offTime: null, seedTime: 8650, place: null, heatPlace: null, qualifying: [], isDq: true },
        { eventId: 'e73', name: '200 Medley Relay', number: '73', schedIdx: 73001, status: 'done',
          heatNum: 2, laneNum: 3, offTime: 11903, place: 1, isDq: false, isRelay: true,
          relayTeam: 'A', legPosition: 2, legStroke: 3, qualifying: [] },
        { eventId: 'e28', name: '50 Fly', number: '28', schedIdx: 28001, status: 'done',
          heatNum: 1, laneNum: 6, offTime: null, seedTime: 4810, place: null, heatPlace: null, qualifying: [], isDq: true },
        { eventId: 'e80', name: '200 Medley Relay', number: '80', schedIdx: 80001, status: 'upcoming',
          heatNum: 2, laneNum: 3, etaEpoch: eta(25 * 60), etaDisplay: etaFmt(25 * 60),
    ...
    },
    {
      ...
      events: [
        { eventId: 'e14', name: '50 Free',  number: '14', schedIdx: 14001, status: 'done',
          heatNum: 1, laneNum: 4, offTime: 3198, seedTime: 3250, place: 2, heatPlace: 2, qualifying: ['INV'], isDq: false },
        { eventId: 'e21', name: '100 Back', number: '21', schedIdx: 21001, status: 'done',
          heatNum: 1, laneNum: 2, offTime: 7801, seedTime: 8000, place: 1, heatPlace: 1, qualifying: ['INV'], isDq: false },
        { eventId: 'e74', name: '200 Free Relay', number: '74', schedIdx: 74001, status: 'done',
          heatNum: 2, laneNum: 5, offTime: 11245, place: 2, isDq: false, isRelay: true,
...
// After 8s: heat 2 of Event 28 finishes; Ethan + Noah get results.
// Lineup banner stays on Event 80 Medley Relay (~5 min to lineup).
export function startDemoAnimation() {
  setTimeout(() => {
    for (const sw of S.swimmers) {
      for (const ev of sw.events) {
        if (ev.eventId !== 'e28' || ev.status !== 'inProgress') continue;
        ev.status = 'done';
        if (sw.name === 'Ethan Miller') {
          ...
          ev.offTime = 4312; ev.place = 5; ev.heatPlace = 2; ev.qualifying = []; ev.isDq = false;
        }
      }
    }
    S.tracker = {
      isLive: true, isComplete: false,
      currentEventNumberDigit: '28', currentHeatNumber: 3,
      currentEventDistance: 50, currentEventStrokeCode: 4,
